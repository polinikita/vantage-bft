...
pub struct VantageProgress {
    ...
    pub direct_resolver_max_view: i64,
    pub resolved_through_view: i64,
    pub direct_resolver_active_targets: i64,
...
pub fn read_vantage_progress(registry: &Registry) -> Option<VantageProgress> {
    ...
    Some(VantageProgress {
        ...
        direct_resolver_max_view: gauge("vantage_direct_resolver_max_view")?,
        resolved_through_view: gauge("vantage_resolved_through_view")?,
        direct_resolver_active_targets: gauge("vantage_direct_resolver_active_targets")?,
